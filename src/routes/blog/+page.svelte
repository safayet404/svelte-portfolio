...
<svelte:head>
    ...
    <meta
        name="description"
        content="Read Safayet's blog posts about web development, Linux, system internals, and software engineering."
    />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {#each blogs as blog, i}
                ...
                >
                    ...
                    {:else}
                        <div
                            class="h-44 bg-gradient-to-br from-[#FF014F]/10 to-transparent flex items-center justify-center"
                        >
                            <svg
                    ...
                    <div class="flex flex-col flex-1 p-5 gap-3">
                        ...
                        >
                            ...
                            <span class="text-xs text-[#FF014F] font-semibold"
                                >{$locale === "bn" ? "পড়ুন" : "Read more"} →</span
                            >
                        </div>
                    </div>
                </a>
