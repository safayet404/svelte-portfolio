  ...
  initAOS()
    ...
    const education = [
        ...
        },
        {
            ...
            institute : "Jatir Janak Bangabandhu Sheikh Mujibur Rahman Government College ",
            cgpa : "4.17 / 5.00",
            session : "2017-2019"
        },
        {
...
<div class="container mx-auto p-4">
    <div class="flex justify-center gap-5">
        {#each tabs as {id,label} }
            <button class=" gap-5 text-xs md:text-base text-center border px-10 py-2 rounded-lg font-semibold text-white mb-2" on:click={() => (activeTab = id)}>
                {label}
            </button>
        {/each}
    </div>
